...
public class UpdateInstanceBuilder<T> implements QueryBuilder.ReturnsInt {
    ...
    public UpdateInstanceBuilder(KiORM db, T target, DocumentParser.NameModifier tableNameModifier, DocumentParser.NameModifier fieldNameModifier, TransactionBuilder transaction) {
        this.db = db;
        this.target = target;
